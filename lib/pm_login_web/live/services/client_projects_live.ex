defmodule PmLoginWeb.Services.ClientProjectsLive do
  ...
  def mount(_params, %{"curr_user_id" => curr_user_id}, socket) do
    ...
    socket =
      ...
      |> assign(projects: Monitoring.list_all_client_projects_by_active_client_id(active_client_id))
      |> assign(show_notif: false)
      |> assign(show_notif: false)
      |> assign(show_notif: false)
      |> assign(show_notif: false)
  ...
  def render(assigns) do
    ClientsRequestView.render("client_projects.html", assigns)
  end
end
